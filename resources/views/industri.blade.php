    ...
    <div class="section">
        <div class="container">
            ...
            <div class="col-12 mb-4 text-center">
                <h2>Kerjasama Sekolah Dengan Industri</h2>
            </div>
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-4 mb-4">
                    <div class="card " style="width: 20rem;">
                        <div class="card-body">
                            ...
                            <p class="card-title">Tahun Kerjasama : {{$data ->tahun_kerjasama}}</p>
                            <p class="card-title">Jurusan : {{$data ->jurusan->nama_jurusan}}</p>
                        </div>
                    </div>
                </div>
                @endforeach
